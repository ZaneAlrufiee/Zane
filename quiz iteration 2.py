...
while not_attempted:
    ...
    # Check if the user wants to reset the quiz.
    if not not_attempted and input("All questions attempted. Enter 'reset' to start over or any other key to exit: ").lower() == "reset":
        not_attempted = attempted[:]
        attempted = []
        random.shuffle(not_attempted)

# Print the results of the quiz.
print("Quiz complete. You answered", correct, "questions correctly and", incorrect, "questions incorrectly.")
